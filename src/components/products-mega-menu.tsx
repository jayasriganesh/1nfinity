  ...
  const categories: CategoryItem[] = [
    ...
    },
    {
      ...
      subCategories: [
        ...
        { label: "Professional Monitors",     href: "/products/commercial-display" },
        { label: "Mirror TV",                 href: "/products/commercial-display" },
        { label: "Digital Standees",          href: "/products/commercial-display" },
      ],
    ...
    },
    {
      ...
      subCategories: [
        { label: "COB LED Video Wall",        href: "/products/led-display" },
        { label: "Transparent LED",           href: "/products/led-display" },
        { label: "All-in-One LED",            href: "/products/led-display" },
        { label: "Outdoor LED",               href: "/products/led-display" },
      ],
